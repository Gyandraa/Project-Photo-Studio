        ...
        <div className="flex gap-10  mt-10 mb-20">
          ...
          <div className="flex-col space-y-2">
            <div>
              ...
              <p className="font-semibold font-sans">Rp 500.000,00 / sesi </p>
              <p className="font-semibold font-sans">Satu sesi 45 menit</p>
            </div>
            <div>
              <h3 className="font-bold text-xl mb-2">Kapasitas</h3>
              <p className="font-semibold font-sans">Maksimal 20 orang</p>
            </div>
            <div>
              <h3 className="font-bold text-xl mb-2">Mendapatkan</h3>
              <p className="font-semibold font-sans">20 file foto edit</p>
              <p className="font-semibold font-sans">20 foto cetak</p>
            </div>
            <div>
