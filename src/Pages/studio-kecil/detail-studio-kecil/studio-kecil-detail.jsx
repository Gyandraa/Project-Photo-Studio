    ...
    <>
      ...
      <section>
        ...
        <div className="flex gap-10  mt-10 mb-20">
          ...
          <div className="flex-col space-y-2 border-4 rounded-2xl border- w-3xl ">
            <div className="ml-5">
              <div>
                <h3 className="font-bold text-xl mb-2">Harga</h3>
                <p className="font-semibold font-sans">Rp 100.000,00 / sesi</p>
                <p className="font-semibold font-sans">Satu sesi 15 menit</p>
              </div>
              <div>
                <h3 className="font-bold text-xl mb-2">Kapasitas</h3>
                <p className="font-semibold font-sans">Maksimal 3 orang</p>
              </div>
              <div>
                <h3 className="font-bold text-xl mb-2">Mendapatkan</h3>
                <p className="font-semibold font-sans">5 file foto edit</p>
                <p className="font-semibold font-sans">2 foto cetak</p>
              </div>
              <div>
