...
import DetailSectionKecil from "../../../Components/detail-section-kecil";
import Photo from "../../../Components/Photo";
export default function StudioKecilDetail() {
  const { id } = useParams();
  const studioData = {
    "kecil-satu": {
      title: "Studio Kecil Satu",
      desc: "Studio kecil cocok untuk personal photoshoot",
    },
    "kecil-dua": {
      title: "Studio Kecil Dua",
      desc: "Studio kecil dengan lighting premium",
    },
    "kecil-tiga": {
      title: "Studio Kecil Tiga",
      desc: "Studio kecil untuk konten profesional",
    },
  };
  const studio = studioData[id];
  if (!studio) {
  ...
  return (
    <>
          ...
          <div className="relative w-full h-[90vh] overflow-hidden">
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center text-white px-4 z-10">
              <h1 className="text-4xl sm:text-4xl md:text-3xl mb-6 text-center drop-shadow-lg font-bold tracking-tight">
                <DetailSectionKecil data={studio} />
              </h1>
      ...
      <section>
        ...
        <div className="flex gap-10  mt-10 mb-20 border-4 rounded-2xl p-5 border-gray-200">
          ...
          <div className="flex-col space-y-2 rounded-2xl">
            ...
            <div>
              <div>
                ...
                <p className="font-sans">Rp 100.000,00 / sesi</p>
                <p className="font-sans">Satu sesi 15 menit</p>
              </div>
              <div>
                <h3 className="font-semibold text-xl mb-2">Kapasitas</h3>
                <p className="font-sans">Maksimal 3 orang</p>
              </div>
              <div>
                <h3 className="font-semibold text-xl mb-2">Mendapatkan</h3>
                <p className="font-sans">5 file foto edit</p>
                <p className="font-sans">2 foto cetak</p>
              </div>
              <div>
              ...
              <button
                className="px-6 mt-3 py-2 rounded-lg bg-amber-500 text-white font-semibold
